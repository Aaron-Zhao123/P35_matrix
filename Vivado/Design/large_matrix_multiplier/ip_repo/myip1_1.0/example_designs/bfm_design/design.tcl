proc create_ipi_design { offsetfile design_name } {
	...
	set myip1_0 [ create_bd_cell -type ip -vlnv user.org:user:myip1:1.0 myip1_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins myip1_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins myip1_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins myip1_0/S00_AXI_ARESETN]
	...
	set offset_file "${bd_path}/myip1_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:myip1:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/myip1_v1_0_tb.v
