...
HD_PWD='/auto/homes/yaz21/P35_project/Design/two_by_two_multiplier/two_by_two_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mat_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mat_mult.tcl
