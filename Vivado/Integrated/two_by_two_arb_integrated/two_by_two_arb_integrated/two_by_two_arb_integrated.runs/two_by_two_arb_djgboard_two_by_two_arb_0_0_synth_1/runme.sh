...
HD_PWD='/auto/homes/yaz21/P35_project/P35_matrix/Vivado/Integrated/two_by_two_arb_integrated/two_by_two_arb_integrated/two_by_two_arb_integrated.runs/two_by_two_arb_djgboard_two_by_two_arb_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_by_two_arb_djgboard_two_by_two_arb_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_by_two_arb_djgboard_two_by_two_arb_0_0.tcl
