...
HD_PWD='/auto/homes/yaz21/P35_project/Integrated/two_by_two_arb_integrated/two_by_two_arb_integrated/two_by_two_arb_integrated.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
