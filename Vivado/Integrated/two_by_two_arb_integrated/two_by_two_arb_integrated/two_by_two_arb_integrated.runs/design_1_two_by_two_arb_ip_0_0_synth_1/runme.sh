...
HD_PWD='/auto/homes/yaz21/P35_project/Integrated/two_by_two_arb_integrated/two_by_two_arb_integrated/two_by_two_arb_integrated.runs/design_1_two_by_two_arb_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_two_by_two_arb_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_two_by_two_arb_ip_0_0.tcl
