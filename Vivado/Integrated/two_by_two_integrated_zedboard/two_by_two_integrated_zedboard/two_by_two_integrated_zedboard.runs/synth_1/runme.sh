...
HD_PWD='/home/aaron/Project/P35_matrix/Vivado/Integrated/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_by_two_arb_zedboard_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_by_two_arb_zedboard_wrapper.tcl
