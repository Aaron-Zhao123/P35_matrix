...
HD_PWD='/home/aaron/Project/P35_matrix/Vivado/Integrated/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_by_two_arb_zedboard_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_by_two_arb_zedboard_wrapper.tcl -notrace
