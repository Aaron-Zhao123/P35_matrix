...
HD_PWD='/home/aaron/Project/P35_matrix/Vivado/Integrated/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard/two_by_two_integrated_zedboard.runs/two_by_two_arb_zedboard_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_by_two_arb_zedboard_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_by_two_arb_zedboard_auto_pc_0.tcl
